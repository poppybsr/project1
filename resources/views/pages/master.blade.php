  ...
  <head>
   ...
   <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav" style="background-color:black">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="/museum">Art museum</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="artobject">Art Object</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="exhibition">Exhibition</a>
            </li>
            <li class="nav-item">
